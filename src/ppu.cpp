...
uint8_t PPU::read(uint16_t address)
{
    ...
    case 2:
    {
        ...
        return (current_status & 0xE0) | (this->prev_read & 0x1F);
    }
    case 3:
        // OAMADDR
...
{
    // Assuming nameTableIndex is either 0 or 1 for the first or second name table
    uint16_t baseAddr = nameTableIndex == 0 ? 0x2000 : 0x2400; // Base address for the name table
